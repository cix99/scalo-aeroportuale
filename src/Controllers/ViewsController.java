...
public class ViewsController {
	...
	public void saveNuovaPrenotazione(String nome, String cognome, String codicePrenotazione, String centoKilometri, String compagniaCentoKilometri, String compagniaVolo, int idTratta, String coda) {
		if (nome.isBlank()) {
			JOptionPane.showMessageDialog(subFrame, "Il campo nome non pu� essere vuoto", "Errore inserimento prenotazione", JOptionPane.ERROR_MESSAGE);
		} else if (cognome.isBlank()) {
			JOptionPane.showMessageDialog(subFrame, "Il campo cognome non pu� essere vuoto", "Errore inserimento prenotazione", JOptionPane.ERROR_MESSAGE);
		} else if (codicePrenotazione.isBlank()) {
			JOptionPane.showMessageDialog(subFrame, "Il campo codice non pu� essere vuoto", "Errore inserimento prenotazione", JOptionPane.ERROR_MESSAGE);
			...
			if (!centoKilometri.isBlank()) {
				...
				if (dbController.checkCentoKilometri(ck, nome, cognome)) {
					if (dbController.saveNuovaPrenotazione(nome, cognome, codicePrenotazione, centoKilometri, compagniaCentoKilometri, compagniaVolo, idTratta, coda)) {
						...
						JOptionPane.showMessageDialog(subFrame, "L\'operazione non � andata a buon fine", "Errore inserimento prenotazione", JOptionPane.ERROR_MESSAGE);
					}
				}
				else {
	...
	public void saveNuovaTratta(String destinazione, String nomeCompagnia, String gate, LocalDateTime dataInizio, LocalDateTime dataFine, String maxPrenotazioni, ArrayList<Coda> code) {
		if (destinazione.isBlank()) {
			...
			JOptionPane.showMessageDialog(subFrame, "La data di fine imbarco non pu� essere prima di quella di inizio", "Errore data", JOptionPane.ERROR_MESSAGE);
			...
			JOptionPane.showMessageDialog(subFrame, "Il gate non � libero nell'arco di tempo selezionato", "Errore gate", JOptionPane.ERROR_MESSAGE);
			...
			JOptionPane.showMessageDialog(subFrame, "L\'operazione non � andata a buon fine", "Errore inserimento tratta", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void saveNuovoCentoKilometri(String codice, String nomeCompagnia, String nome, String cognome, String punti) {
		if (codice.isBlank()) {
			...
			JOptionPane.showMessageDialog(subFrame, "Il campo nome non pu� essere vuoto", "Errore inserimento cento kilometri", JOptionPane.ERROR_MESSAGE);
		} else if (cognome.isBlank()) {
			JOptionPane.showMessageDialog(subFrame, "Il campo cognome non pu� essere vuoto", "Errore inserimento cento kilometri", JOptionPane.ERROR_MESSAGE);
			...
			JOptionPane.showMessageDialog(subFrame, "L\'operazione non � andata a buon fine", "Errore inserimento cento kilometri", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void saveNuovaCompagniaAerea(String nomeCompagnia) {
		if (nomeCompagnia.isBlank()) {
			...
			JOptionPane.showMessageDialog(subFrame, "La compagnia � gi� stata inserita", "Errore inserimento compagnia", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void saveNuovoGate(String nomeGate) {
		if (nomeGate.isBlank()) {
			...
			JOptionPane.showMessageDialog(subFrame, "L\'operazione non � andata a buon fine", "Errore inserimento gate", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void updateFineImbarcoCoda(String nomeCoda) {
		...
		if (cursor.hasNext()) {
			...
			if (current.getFineImbarcoCoda() == null) {
				...
				JOptionPane.showMessageDialog(subFrame, "La coda " + nomeCoda + " � gi� stata chiusa", "Errore update", JOptionPane.ERROR_MESSAGE); //questo non dovrebbe mai apparire
			}	
		}
